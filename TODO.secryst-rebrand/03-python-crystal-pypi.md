...
Status: DONE — PyPI LIVE. 0.1.0 first publish 2026-08-20 via trusted
publishing (gh workflow run release.yml, no tokens); 0.1.1 same day
(exports cache_dir/load_index for TS-crystal API parity; docstring
names secryst). Verified: pip install + tokenizer roundtrip + env
overrides from a clean venv.
